...
import { ActionCard, inlineActionToDraft } from "./ActionCard";
        ...
        <div key={date}>
          ...
          {dayMessages.map((msg, idx) => (
            <div key={idx}>
              ...
              {/* Inline action card — single dispatch for email / sms / call / calendar */}
              {msg.action &&
                msg.action.type !== "task" &&
                (() => {
                  const draft = inlineActionToDraft(msg.action);
