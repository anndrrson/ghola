...
function contractSpec(snapshot, conservativeFundingRate) {
  ...
  return {
    ...
    funding_settlement_asset: snapshot.funding_settlement_asset,
    fee_settlement_asset: snapshot.fee_settlement_asset,
    asset_valuations: snapshot.asset_valuations,
