...
//! `thumper_relay::auth::require_sealed_envelope_auth` against an axum
...
use thumper_relay::auth::require_sealed_envelope_auth;
use thumper_relay::config::RelayConfig;
use thumper_relay::did_set::DidSet;
use thumper_relay::state::AppState;
...
fn test_config() -> RelayConfig {
    RelayConfig {
        ...
        ohttp_key_id: thumper_relay::config::DEFAULT_OHTTP_KEY_ID,
        did_set_url: None,
