...
//! a synthetic quote. The relay running with `THUMPER_ALLOW_UNATTESTED=1`
...
use thumper_types::EnclaveKeyId;
...
pub fn request_quote(keys: &EnclaveKeys, timestamp_ms: i64) -> Result<Vec<u8>> {
    ...
    #[cfg(feature = "mock-nitro")]
    {
        ...
        // `THUMPER_ALLOW_UNATTESTED=1` doesn't run `said-attest` over
