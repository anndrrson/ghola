...
if (mainnetLive) {
  ...
  const expectedCapabilities = out.PRIVATE_AGENT_HYPERLIQUID_RISK_REDUCTION_ENABLED === "true"
    ? "limit_order,cancel,reduce_only"
    : "limit_order";
  if (out.PRIVATE_AGENT_LIVE_TRADING_CAPABILITIES !== expectedCapabilities) {
