...
def main():
    ...
    try:
        if payload.get("verify_no_submit"):
            ...
            # A no-submit proof must validate venue reachability, account
            # state, sizing, and order construction without requiring funded
            # collateral. The live submit path below still enforces funds.
