...
use ghola_models_types::{AuthResponse, NonceRequest, NonceResponse, User, VerifyRequest};
...
pub async fn register_email(
    State(state): State<Arc<AppState>>,
    Json(req): Json<ghola_models_types::EmailRegisterRequest>,
) -> AppResult<Json<AuthResponse>> {
...
pub async fn login_email(
    State(state): State<Arc<AppState>>,
    Json(req): Json<ghola_models_types::EmailLoginRequest>,
) -> AppResult<Json<AuthResponse>> {
