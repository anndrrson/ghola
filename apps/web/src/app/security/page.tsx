...
const MODES = [
  {
    ...
    rows: [
      ...
      },
      {
        ...
        v: "Today, Private mode encrypts to a Ghola-operated provider key on hardened bare metal. Hardware attestation (AWS Nitro) lands in v2 — at which point the receipt gains a verifiable measurement.",
      },
    ],
  },
  {
...
const ROADMAP = [
  {
    ...
    items: [
      "Sovereignty Modes ship in the chat UI; per-message receipts in IndexedDB",
      "Inference dispatch is sealed end-to-end to a pinned provider key — the relay no longer reads plaintext",
      "On-chain anchoring deferred to v2; receipts are signed but not yet ledger-anchored",
    ],
  },
  {
    phase: "v2",
    when: "Next",
    title: "Real attestation + open ledger",
    items: [
