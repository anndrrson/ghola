    ...
    <div className="space-y-3">
      {DAYS.map(({ key, label }) => {
        ...
        return (
          <div
            key={key}
            className="flex flex-wrap items-center gap-3 rounded-lg border border-gray-700 bg-gray-900/50 px-3 py-2"
          >
            ...
            <input
              ...
              className="rounded-lg border border-gray-700 bg-gray-900 px-3 py-1.5 text-sm text-gray-50 focus:border-said-500 focus:outline-none disabled:opacity-40 disabled:cursor-not-allowed"
            />
            ...
            <label className="ml-auto flex items-center gap-2 cursor-pointer">
              ...
              <button
                ...
                className={`relative h-5 w-9 rounded-full transition-colors cursor-pointer ${
                  closed ? "bg-red-500/60" : "bg-gray-700"
                }`}
              >
                <span
