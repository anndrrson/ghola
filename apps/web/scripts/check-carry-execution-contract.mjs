...
export function checkCarryExecutionContract(sources) {
  ...
  requireText("releaseMaterialTest", "keeps lifecycle proof bodies immutable across idempotent and divergent records", "carry_lifecycle_proof_body_immutability_test_missing");
  requireText("releaseMaterialTest", "fails closed without overwriting when divergent lifecycle proofs race", "carry_lifecycle_proof_body_concurrency_test_missing");
